...
# with open("out_va.json") as f:
#    vafile=json.load(f)
# slice=vafile["slices"][0]
# print(slice.keys(),np.shape(slice["markers"]),np.shape(slice["anchoring"]))
# width=slice["width"]
# height=slice["height"]
#
# triangulation = VAL.triangulate(width,height,slice["markers"])
#
# for _ in range(10):
#    x,y = random.randrange(width),random.randrange(height)
#    i,j = VAL.transform(triangulation,x,y)
#    print(x,y,i,j,*VAL.forwardtransform(triangulation,i,j))
